    ...
    const navigation=useNavigation();
        ...
        return(
            ...
            <View style={{ marginTop: 15, marginBottom: 5, marginLeft: 'auto', marginRight: 'auto', flexDirection: 'column', justifyContent: 'space-between', width: '90%', padding: 5, backgroundColor: '#3e2387' }}>
                <Text style={{ marginLeft: 'auto', marginRight: 'auto', fontSize: 25, fontWeight: 'bold',textAlign:'center' , color:"#FFF",}}>Udaya Devi</Text>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 1, paddingLeft: 30, paddingRight: 30 }}>
                    <Text style={{ fontSize: 20,color:"#FFFFFF" }}>06.35</Text>
                    <Text style={{ fontSize: 20 , color:"#FFFFFF" }}>15.00</Text>
                </View>
            </View>
            {/* Seats */}
        </View>
...
export default BookingPageUdayaDevi;