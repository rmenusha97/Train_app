...
async function booking(number) {
    firestore()
        .collection('temp').doc("GAEriS7CJYlqZ4uoa5f1")
        .update({
            num: number,
    ...
    return (
        <ScrollView>
                    ...
                    <View>
                        ...
                        <View style={{ marginTop: 15, marginBottom: 5, marginLeft: 'auto', marginRight: 'auto', flexDirection: 'column', justifyContent: 'space-between', width: '90%', padding: 5, backgroundColor: '#3e2387' }}>
                            ...
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 1, paddingLeft: 30, paddingRight: 30 }}>
                                <Text style={{ fontSize: 20, color: "#FFFFFF" }}>Rs.<Text style={{ fontSize: 20, color: "#FFFFFF" }}>{global.data['secondClass']['price']}<Text style={{ fontSize: 20, color: "#FFFFFF" }}>/-</Text></Text></Text>
                                <Text style={{ fontSize: 20, color: "#FFFFFF" }}>{global.data['secondClass']['seats']  - global.data['bookedSeatsSecondClass']}</Text>
                            </View>
                        </View>
                        {/* Seats */}
                    </View>
            ...
            <View style={{ flex: 1, backgroundColor: '#3e2387', marginTop: 30 }}>
                <Text style={{ marginLeft: 'auto', marginRight: 'auto', fontSize: 25, fontWeight: 'bold', textAlign: 'center', color: "#FFF", }}>Second Class</Text>
                <SafeAreaView >
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-around', marginTop: 15, marginBottom: 5 }}>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                            ...
                            <View style={[styles.SeatContainer, { width: 30, height: 30 }]}>
                                <TouchableOpacity>
                                    <Image source={require('../assets/TrainSeat1.png')} style={{ width: 20, height: 20, borderRadius: 1000 }} onPress={() => setVisible(true)} />
