        ...
        <SafeAreaView>
            ...
            >
                ...
                <ScrollView>
                    ...
                    <View >
                        <Text style={{ fontSize: 26, padding: 10, fontWeight: 'bold', textAlign: 'center', color: "#000000", marginBottom: 30, }}>Book Your Ticket Here!</Text>
                    </View>
                    <View style={styles.formInput}>
                        <TextInput style={styles.textInput} placeholder="Your Email Address" placeholderTextColor="#000" />
                    </View>

                    <View style={styles.formInput}>
                        <TextInput style={styles.textInput} placeholder="Password" secureTextEntry={true}  placeholderTextColor="#000"/>
                    </View>
                    <View style={styles.formInput}>
